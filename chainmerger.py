...
try:
  ...
  print("Trying to Install required module: tldextract\n")
  os.system('python -m pip install tldextract')
try:
  import openpyxl
except ImportError:
...
try:
  ...
  print("Trying to Install required module: xlsxwriter\n")
  os.system('python -m pip install xlsxwriter')

print('')
print('----- Chainalysis csv-export merging-tool V0.2 -----')
print('')
...
def merger(): # merges given csv files into 1 xlsx
    ...
    for i in os.listdir(mergedxlsx):
        ...
        print('--> adding sheet ' + splitext(i)[0])
    writer.save()
    print('-----> ' + reportfile)
    print('')
